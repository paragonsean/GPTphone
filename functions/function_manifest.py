tools = [
    ...
    },
    {
        ...
        "function": {
            "name": "log_features",
            "description": "Log new function ideas and ask if the person would like to add their name for credit.",
            "parameters": {
                "type": "object",
                "properties": {}
                },
            "say": "Logging features. Would you like to add your name for credit?"
        }
    },
    {
        "type": "function",
